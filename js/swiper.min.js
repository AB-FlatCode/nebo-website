          ...
          if (!(a.params.threshold && Math.sqrt(Math.pow(u, 2) + Math.pow(h, 2)) < a.params.threshold)) {
            ...
            if ((i.isScrolling && a.emit('touchMoveOpposite', l), void 0 === i.startMoving && ((n.currentX === n.startX && n.currentY === n.startY) || (i.startMoving = !0)), i.isScrolling)) i.isTouched = !1;
              ...
              (a.allowClick = !1),
                ...
                i.isMoved || (s.loop && a.loopFix(), (i.startTranslate = a.getTranslate()), a.setTransition(0), a.animating && a.$wrapperEl.trigger('webkitTransitionEnd transitionend'), (i.allowMomentumBounce = !1), !s.grabCursor || (!0 !== a.allowSlideNext && !0 !== a.allowSlidePrev) || a.setGrabCursor(!0), a.emit('sliderFirstMove', l)),
                a.emit('sliderMove', l),
                (i.isMoved = !0);
              ...
              if (
                ...
                f > 0 && i.currentTranslate > a.minTranslate() ? ((g = !1), s.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + f, b))) : f < 0 && i.currentTranslate < a.maxTranslate() && ((g = !1), s.resistance && (i.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - i.startTranslate - f, b))),
      ...
      update: {
        updateSize: function () {
          ...
          (e = void 0 !== a.params.width && null !== a.params.width ? a.params.width : i[0].clientWidth),
            ...
            (0 === e && a.isHorizontal()) || (0 === t && a.isVertical()) || ((e = e - parseInt(i.css('padding-left') || 0, 10) - parseInt(i.css('padding-right') || 0, 10)), (t = t - parseInt(i.css('padding-top') || 0, 10) - parseInt(i.css('padding-bottom') || 0, 10)), Number.isNaN(e) && (e = 0), Number.isNaN(t) && (t = 0), C(a, { width: e, height: t, size: a.isHorizontal() ? e : t }));
        },
            ...
            for (var M, z, P, k = i.slidesPerColumn, L = T / k, $ = Math.floor(c / i.slidesPerColumn), I = 0; I < c; I += 1) {
              ...
              if ('none' !== O.css('display')) {
                ...
                p[I] && (p[I].swiperSlideSize = S),
                  v.push(S),
                  i.centeredSlides ? ((y = y + S / 2 + E / 2 + w), 0 === E && 0 !== I && (y = y - r / 2 - w), 0 === I && (y = y - r / 2 - w), Math.abs(y) < 0.001 && (y = 0), i.roundLengths && (y = Math.floor(y)), x % i.slidesPerGroup == 0 && u.push(y), h.push(y)) : (i.roundLengths && (y = Math.floor(y)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), (y = y + S + w)),
                  (e.virtualSize += S + w),
                  (E = S),
                  (x += 1);
              }
      ...
      classes: {
        addClasses: function () {
          var e,
            ...
            d = i.support,
            p =
              ((e = ['initialized', r.direction, { 'pointer-events': d.pointerEvents && !d.touch }, { 'free-mode': r.freeMode }, { autoheight: r.autoHeight }, { rtl: n }, { multirow: r.slidesPerColumn > 1 }, { 'multirow-column': r.slidesPerColumn > 1 && 'column' === r.slidesPerColumnFill }, { android: l.android }, { ios: l.ios }, { 'css-mode': r.cssMode }]),
      ...
      function t() {
        ...
        return (
          ...
          C(o, {
            ...
            touchEvents: ((l = ['touchstart', 'touchmove', 'touchend', 'touchcancel']), (d = ['mousedown', 'mousemove', 'mouseup']), o.support.pointerEvents && (d = ['pointerdown', 'pointermove', 'pointerup']), (o.touchEventsTouch = { start: l[0], move: l[1], end: l[2], cancel: l[3] }), (o.touchEventsDesktop = { start: d[0], move: d[1], end: d[2] }), o.support.touch || !o.params.simulateTouch ? o.touchEventsTouch : o.touchEventsDesktop),
            touchEventsData: { isTouched: void 0, isMoved: void 0, allowTouchCallbacks: void 0, touchStartTime: void 0, isScrolling: void 0, currentTranslate: void 0, startTranslate: void 0, allowThresholdMove: void 0, formElements: 'input, select, option, textarea, button, video, label', lastClickTime: x(), clickTimeout: void 0, velocities: [], allowMomentumBounce: void 0, isTouchEvent: void 0, startMoving: void 0 },
            allowClick: !0,
      ...
      return (
        ...
        (r.mount = function (e) {
          ...
          return (
            ...
            C(t, { $el: i, el: e, $wrapperEl: a, wrapperEl: a[0], mounted: !0, rtl: 'rtl' === e.dir.toLowerCase() || 'rtl' === i.css('direction'), rtlTranslate: 'horizontal' === t.params.direction && ('rtl' === e.dir.toLowerCase() || 'rtl' === i.css('direction')), wrongRTL: '-webkit-box' === a.css('display') }),
            !0)
          );
        }),
        (r.init = function (e) {
  ...
  var K = {
      ...
      animateSlider: function (e) {
        ...
        return (
          ...
          ((e.delta >= 6 && x() - t.mousewheel.lastScrollTime < 60) || (e.direction < 0 ? (t.isEnd && !t.params.loop) || t.animating || (t.slideNext(), t.emit('scroll', e.raw)) : (t.isBeginning && !t.params.loop) || t.animating || (t.slidePrev(), t.emit('scroll', e.raw)), (t.mousewheel.lastScrollTime = new a.Date().getTime()), !1))
        );
      },
          ...
          if ((e.params.loop ? ((i = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > s - 1 - 2 * e.loopedSlides && (i -= s - 2 * e.loopedSlides), i > n - 1 && (i -= n), i < 0 && 'bullets' !== e.params.paginationType && (i = n + i)) : (i = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0), 'bullets' === a.type && e.pagination.bullets && e.pagination.bullets.length > 0)) {
            ...
            if (
              (a.dynamicBullets &&
                ...
                a.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((e.pagination.dynamicBulletIndex += i - e.previousIndex), e.pagination.dynamicBulletIndex > a.dynamicMainBullets - 1 ? (e.pagination.dynamicBulletIndex = a.dynamicMainBullets - 1) : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)),
    ...
    te = {
      ...
      in: function (e) {
        var t,
          ...
          x = y.gesture,
          T = y.image;
        (x.$slideEl || (b.params.virtual && b.params.virtual.enabled && b.virtual ? (x.$slideEl = b.$wrapperEl.children('.' + b.params.slideActiveClass)) : (x.$slideEl = b.slides.eq(b.activeIndex)), (x.$imageEl = x.$slideEl.find('img, svg, canvas, picture, .swiper-zoom-target')), (x.$imageWrapEl = x.$imageEl.parent('.' + E.containerClass))), x.$imageEl && 0 !== x.$imageEl.length) &&
          (x.$slideEl.addClass('' + E.zoomedSlideClass),
          void 0 === T.touchesStart.x && e ? ((t = 'touchend' === e.type ? e.changedTouches[0].pageX : e.pageX), (a = 'touchend' === e.type ? e.changedTouches[0].pageY : e.pageY)) : ((t = T.touchesStart.x), (a = T.touchesStart.y)),
          (y.scale = x.$imageWrapEl.attr('data-swiper-zoom') || E.maxRatio),
          (y.currentScale = x.$imageWrapEl.attr('data-swiper-zoom') || E.maxRatio),
          e
            ? ((m = x.$slideEl[0].offsetWidth), (g = x.$slideEl[0].offsetHeight), (i = x.$slideEl.offset().left + w.scrollX + m / 2 - t), (s = x.$slideEl.offset().top + w.scrollY + g / 2 - a), (l = x.$imageEl[0].offsetWidth), (d = x.$imageEl[0].offsetHeight), (p = l * y.scale), (c = d * y.scale), (v = -(u = Math.min(m / 2 - p / 2, 0))), (f = -(h = Math.min(g / 2 - c / 2, 0))), (r = i * y.scale) < u && (r = u), r > v && (r = v), (n = s * y.scale) < h && (n = h), n > f && (n = f))
            : ((r = 0), (n = 0)),
    ...
    ue = {
      init: function () {
        ...
        var a = e.constructor;
        return (
          t.swiper instanceof a ? ((e.thumbs.swiper = t.swiper), C(e.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), C(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 })) : S(t.swiper) && ((e.thumbs.swiper = new a(C({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
    ...
    he = [
      ...
      U,
      {
        ...
        create: function () {
          M(this, { mousewheel: { enabled: !1, lastScrollTime: x(), lastEventBeforeSnap: void 0, recentWheelEvents: [], enable: K.enable, disable: K.disable, handle: K.handle, handleMouseEnter: K.handleMouseEnter, handleMouseLeave: K.handleMouseLeave, animateSlider: K.animateSlider, releaseScroll: K.releaseScroll } });
        },
        on: {
          init: function (e) {
